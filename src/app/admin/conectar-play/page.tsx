...
function Delete({ id, table }: { id: string; table: string }) { return <form action={deletePlayItem}><input name="id" type="hidden" value={id} /><input name="table" type="hidden" value={table} /><button className="text-sm font-bold text-red-700" type="submit">Eliminar</button></form>; }
