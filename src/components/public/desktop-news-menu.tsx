...
export function DesktopNewsMenu({
  item,
  linkClass,
}: Readonly<{
            ...
            {item.children?.map((child) => {
              ...
              return (
                <Link
                  ...
                  className={`block rounded-lg px-4 py-2.5 text-sm font-semibold text-slate-100 hover:bg-white/10 focus-visible:outline-2 focus-visible:outline-white ${
