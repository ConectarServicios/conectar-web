...
export type Promotion = {
  ...
  image_path: string | null; button_text: string | null; button_url: string | null;
  starts_at: string | null; ends_at: string | null; active: boolean; featured: boolean;
  placements: PromotionPlacement[]; display_order: number; created_at: string; updated_at?: string;
};
export type PromotionFormValues = Omit<Promotion, "id" | "created_at" | "updated_at">;
export type PromotionActionState = { message?: string; fieldErrors?: Record<string, string> };
